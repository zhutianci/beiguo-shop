...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Pro 档单价高，这个疑虑是合理的。可以核验的部分：本站由益阳市赫山区必高科技有限公司运营，能开具增值税发票；价格、库存、累计成交数都公开在页面上；交付的是卡密，充值动作在你自己手里；退款规则（掉订阅按天退、已核销不退、封号不质保）写在明处。真不放心，可以先在便宜得多的 Plus 档跑通一次流程，再回来买 Pro。',
  },
]
