 ...
 *
 * 【2026-09-22 修正】这里原来有一句「本站上架的是 Max 5x 档」，是错的：
 * 商品 3「Claude Max20x自助充值」￥1900 一直有货、已售 26 笔。
 * 而那句话进了 FAQPage 结构化数据，等于在主动劝退客单价最高的那一档买家。
 * 改商品或改档位时回来核对这一页，价格表是实时取库的、FAQ 不是。
 *
...
const FAQS: { q: string; a: string }[] = [
  {
    q: 'Claude Max 一个月多少钱？',
    a: '官方网页端订阅的公开定价是 Max 5x 每月 100 美元、Max 20x 每月 200 美元，苹果内购渠道更贵，Max 5x 是每月 125 美元（以官方页面为准，官方会调整）。本站两档都有：Max 5x 与 Max 20x，均走苹果订阅充值，人民币价格以本页价格表里显示的实付金额为准，随上游成本浮动。',
  },
  {
