...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: '这个行业里无照个人卖家占多数，收钱跑路、或者要你把账号交出去的都有，所以这个疑虑是合理的。可以核验的几点：本站由益阳市赫山区必高科技有限公司运营，能开具增值税发票；价格、库存、累计成交数全部公开在页面上；交付卡密而不碰你的账号密码；退款规则（掉订阅按剩余天数退、未使用卡密可退、已核销不退、封号不质保）写在服务条款里。不放心可以先在 Claude Pro 那一档买一次小额的跑通流程，再回来买 Max。',
  },
  {
    q: '充上去之后被封号了，能退钱吗？',
