...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: '搜「codex 接码 linux do」或者「代充 靠谱吗」的人，都是在找有人用过的证据，这种谨慎是对的。可以核验的有几条：本站由益阳市赫山区必高科技有限公司运营，能开具增值税发票；价格、库存、累计成交数直接显示在本页的表里，成交数是真实订单数；交付的是卡密，不需要你交出任何账号密码；退款与质保规则公开写在服务条款里。最便宜的一档只要几块钱，不放心就先花这个钱把流程跑通一次再说。',
  },
  {
