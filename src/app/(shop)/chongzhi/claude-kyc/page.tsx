...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: '这个行业里无照个人卖家占多数，怀疑是合理的。可核验的标准就几条：卖家有没有真实经营主体、能不能开票、退款规则是不是公开写死的、以及有没有在承诺它根本控制不了的结果。本站由益阳市赫山区必高科技有限公司运营，价格与累计成交数公开在页面上，可开增值税发票，并且明确写着不保证通过、失败不收费。反过来说，任何跟你讲「内部通道」「百分百秒过」的卖家，可以直接排除。',
  },
]
          ...
          <CheckList
            items={[
              ...
              <>
                ...
                ：订单完成后在站内申请，支持增值税发票或收据。抬头由你自己填（公司名或个人都行），
